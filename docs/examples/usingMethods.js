...
async function run () {
  ...
  const link = vkcoin.api.getLink(10000, true, false) // Получение ссылки на отправку платежа (10,000 коинов без возможности изменения, зашифрованную с помощью HEX)
